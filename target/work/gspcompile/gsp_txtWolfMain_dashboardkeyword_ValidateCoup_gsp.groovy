...
class gsp_txtWolfMain_dashboardkeyword_ValidateCoup_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/keyword_ValidateCoup.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
for( _it1903856246 in (keywordsIn) ) {
changeItVariable(_it1903856246)
printHtmlPart(15)
...
invokeTag('form','g',285,['id':("txtForm"),'class':("form-horizontal"),'controller':("Dashboard"),'action':("validateCoup"),'enctype':("multipart/form-data")],2)
printHtmlPart(59)
invokeTag('javascript','g',303,['src':("dashboard/plugins/jQuery/jQuery-2.1.4.min.js")],-1)
printHtmlPart(60)
invokeTag('javascript','g',305,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(61)
invokeTag('javascript','g',307,['src':("dashboard/app.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',308,['src':("dashboard/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',309,['src':("dashboard/plugins/select2/select2.full.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',310,['src':("tagsinput/dist/bootstrap-tagsinput.min.js")],-1)
printHtmlPart(62)
invokeTag('javascript','g',312,['src':("dashboard/plugins/input-mask/jquery.inputmask.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',313,['src':("dashboard/plugins/input-mask/jquery.inputmask.date.extensions.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',314,['src':("dashboard/plugins/input-mask/jquery.inputmask.extensions.js")],-1)
printHtmlPart(63)
invokeTag('javascript','g',317,['src':("dashboard/plugins/daterangepicker/daterangepicker.js")],-1)
printHtmlPart(64)
invokeTag('javascript','g',319,['src':("dashboard/plugins/colorpicker/bootstrap-colorpicker.min.js")],-1)
printHtmlPart(65)
invokeTag('javascript','g',321,['src':("dashboard/plugins/timepicker/bootstrap-timepicker.min.js")],-1)
printHtmlPart(66)
invokeTag('javascript','g',323,['src':("dashboard/plugins/iCheck/icheck.min.js")],-1)
printHtmlPart(67)
invokeTag('javascript','g',325,['src':("dashboard/plugins/fastclick/fastclick.min.js")],-1)
printHtmlPart(68)
})
invokeTag('captureBody','sitemesh',355,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(69)
}
...
public static final long LAST_MODIFIED = 1480388265861L
