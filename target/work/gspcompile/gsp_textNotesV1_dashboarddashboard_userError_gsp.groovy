...
printHtmlPart(14)
for( _it1090083719 in (keywordsIn) ) {
changeItVariable(_it1090083719)
printHtmlPart(15)
...
invokeTag('link','g',266,['class':("btn btn-default"),'action':("newKeyWord"),'type':("button")],3)
printHtmlPart(59)
}
else if(true && (button == 'Coupon-None')) {
printHtmlPart(57)
createClosureForHtmlPart(60, 3)
invokeTag('link','g',269,['class':("btn btn-default"),'action':("validateCoup"),'type':("button")],3)
printHtmlPart(57)
createClosureForHtmlPart(61, 3)
invokeTag('link','g',270,['class':("btn btn-default"),'action':("dashboard"),'type':("button")],3)
printHtmlPart(59)
}
else {
printHtmlPart(57)
createClosureForHtmlPart(61, 3)
invokeTag('link','g',273,['class':("btn btn-default"),'action':("dashboard"),'type':("button")],3)
printHtmlPart(59)
}
printHtmlPart(62)
invokeTag('javascript','g',362,['src':("dashboard/plugins/jQuery/jQuery-2.1.4.min.js")],-1)
printHtmlPart(63)
invokeTag('javascript','g',364,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(64)
invokeTag('javascript','g',366,['src':("dashboard/app.min.js")],-1)
printHtmlPart(65)
})
invokeTag('captureBody','sitemesh',371,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(66)
}
...
public static final long LAST_MODIFIED = 1473642309919L
