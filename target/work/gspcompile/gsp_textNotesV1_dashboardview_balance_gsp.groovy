...
class gsp_textNotesV1_dashboardview_Balance_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/view_Balance.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
for( _it1711050460 in (keywordsIn) ) {
changeItVariable(_it1711050460)
printHtmlPart(15)
...
printHtmlPart(57)
expressionOut.print(UAI.accountType)
printHtmlPart(58)
...
expressionOut.print(bal.monthlyBalance)
printHtmlPart(62)
invokeTag('formatDate','g',286,['format':("MM-dd-yyyy"),'date':(bal.monthlyResetDate)],-1)
printHtmlPart(63)
createClosureForHtmlPart(64, 2)
invokeTag('link','g',291,['class':("btn btn-default"),'action':("history"),'params':([]),'type':("button")],2)
printHtmlPart(65)
createClosureForHtmlPart(66, 2)
invokeTag('link','g',292,['class':("btn btn-default"),'action':("dashboard"),'params':([]),'type':("button")],2)
printHtmlPart(67)
createClosureForHtmlPart(68, 2)
invokeTag('link','g',310,['action':("suspendKeyword"),'params':([promotionID:params.promotionID]),'type':("button"),'class':("btn btn-warning pull-left")],2)
printHtmlPart(69)
...
invokeTag('captureBody','sitemesh',432,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(73)
}
...
public static final long LAST_MODIFIED = 1479950304527L
