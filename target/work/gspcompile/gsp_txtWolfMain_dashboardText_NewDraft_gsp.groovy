...
class gsp_txtWolfMain_dashboardText_NewDraft_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/Text_NewDraft.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
for( _it1975492199 in (keywordsIn) ) {
changeItVariable(_it1975492199)
printHtmlPart(15)
...
printHtmlPart(18)
invokeTag('formatDate','g',82,['format':("MM-dd-yyyy"),'date':(it.date)],-1)
printHtmlPart(19)
}
printHtmlPart(20)
}
...
printHtmlPart(31)
invokeTag('formatDate','g',135,['format':("yyyy"),'date':(session.signUpDate)],-1)
printHtmlPart(32)
...
invokeTag('form','g',176,['controller':("Dashboard"),'action':("contacts"),'enctype':("multipart/form-data"),'class':("sidebar-form")],2)
printHtmlPart(38)
expressionOut.print(createLink(controller: 'Dashboard', action: 'Dashboard'))
printHtmlPart(39)
...
invokeTag('form','g',313,['id':("txtForm"),'class':("form-signin"),'controller':("Dashboard"),'action':("newDraft"),'enctype':("multipart/form-data")],2)
printHtmlPart(59)
})
invokeTag('captureBody','sitemesh',330,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(60)
invokeTag('javascript','g',333,['src':("dashboard/plugins/jQuery/jQuery-2.1.4.min.js")],-1)
printHtmlPart(61)
invokeTag('javascript','g',335,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(62)
invokeTag('javascript','g',337,['src':("dashboard/app.min.js")],-1)
printHtmlPart(63)
invokeTag('javascript','g',338,['src':("dashboard/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js")],-1)
printHtmlPart(63)
invokeTag('javascript','g',339,['src':("dashboard/plugins/select2/select2.full.min.js")],-1)
printHtmlPart(63)
invokeTag('javascript','g',340,['src':("tagsinput/dist/bootstrap-tagsinput.min.js")],-1)
printHtmlPart(63)
invokeTag('javascript','g',341,['src':("dataAccess.js")],-1)
printHtmlPart(64)
invokeTag('javascript','g',343,['src':("dashboard/plugins/input-mask/jquery.inputmask.js")],-1)
printHtmlPart(63)
invokeTag('javascript','g',344,['src':("dashboard/plugins/input-mask/jquery.inputmask.date.extensions.js")],-1)
printHtmlPart(63)
invokeTag('javascript','g',345,['src':("dashboard/plugins/input-mask/jquery.inputmask.extensions.js")],-1)
printHtmlPart(65)
invokeTag('javascript','g',348,['src':("dashboard/plugins/daterangepicker/daterangepicker.js")],-1)
printHtmlPart(66)
invokeTag('javascript','g',350,['src':("dashboard/plugins/colorpicker/bootstrap-colorpicker.min.js")],-1)
printHtmlPart(67)
invokeTag('javascript','g',352,['src':("dashboard/plugins/timepicker/bootstrap-timepicker.min.js")],-1)
printHtmlPart(68)
invokeTag('javascript','g',354,['src':("dashboard/plugins/iCheck/icheck.min.js")],-1)
printHtmlPart(69)
}
...
public static final long LAST_MODIFIED = 1483923624565L
