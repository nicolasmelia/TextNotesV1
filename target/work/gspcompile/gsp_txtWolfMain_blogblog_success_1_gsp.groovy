...
class gsp_txtWolfMain_blogblog_success_1_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/blog/blog_success_1.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(23)
expressionOut.print(resource(dir: 'images', file: 'blog/keywords/success1.jpg'))
printHtmlPart(24)
...
expressionOut.print(createLink(controller: 'blog', params: [blogID: '2']))
printHtmlPart(27)
invokeTag('javascript','g',183,['src':("jquery.min.js")],-1)
printHtmlPart(28)
invokeTag('javascript','g',184,['src':("jquery.dropotron.min.js")],-1)
printHtmlPart(29)
invokeTag('javascript','g',185,['src':("jquery.scrollgress.min.js")],-1)
printHtmlPart(28)
invokeTag('javascript','g',186,['src':("skel.min.js")],-1)
printHtmlPart(28)
invokeTag('javascript','g',187,['src':("util.js")],-1)
printHtmlPart(30)
invokeTag('javascript','g',188,['src':("main.js")],-1)
printHtmlPart(30)
invokeTag('javascript','g',189,['src':("jquery.scrolly.min.js")],-1)
printHtmlPart(31)
invokeTag('javascript','g',190,['src':("ie/respond.min.js")],-1)
printHtmlPart(32)
})
...
public static final long LAST_MODIFIED = 1483924107594L
