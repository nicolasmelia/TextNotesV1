...
class gsp_textNotesV1_dashboardkeyword_ChooseConWinner_gsp extends GroovyPage {
...
printHtmlPart(14)
for( _it177849388 in (keywordsIn) ) {
changeItVariable(_it177849388)
printHtmlPart(15)
...
invokeTag('form','g',310,['id':("txtForm"),'class':("form-horizontal"),'controller':("Dashboard"),'action':("contestSelect"),'style':("margin: auto;"),'enctype':("multipart/form-data")],2)
printHtmlPart(67)
invokeTag('javascript','g',328,['src':("dashboard/plugins/jQuery/jQuery-2.1.4.min.js")],-1)
printHtmlPart(68)
invokeTag('javascript','g',330,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(69)
invokeTag('javascript','g',332,['src':("dashboard/app.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',333,['src':("dashboard/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',334,['src':("dashboard/plugins/select2/select2.full.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',335,['src':("tagsinput/dist/bootstrap-tagsinput.min.js")],-1)
printHtmlPart(70)
invokeTag('javascript','g',337,['src':("dashboard/plugins/input-mask/jquery.inputmask.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',338,['src':("dashboard/plugins/input-mask/jquery.inputmask.date.extensions.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',339,['src':("dashboard/plugins/input-mask/jquery.inputmask.extensions.js")],-1)
printHtmlPart(71)
invokeTag('javascript','g',342,['src':("dashboard/plugins/daterangepicker/daterangepicker.js")],-1)
printHtmlPart(72)
invokeTag('javascript','g',344,['src':("dashboard/plugins/colorpicker/bootstrap-colorpicker.min.js")],-1)
printHtmlPart(73)
invokeTag('javascript','g',346,['src':("dashboard/plugins/timepicker/bootstrap-timepicker.min.js")],-1)
printHtmlPart(74)
invokeTag('javascript','g',348,['src':("dashboard/plugins/iCheck/icheck.min.js")],-1)
printHtmlPart(75)
invokeTag('javascript','g',350,['src':("dashboard/plugins/fastclick/fastclick.min.js")],-1)
printHtmlPart(76)
})
invokeTag('captureBody','sitemesh',380,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(77)
}
...
public static final long LAST_MODIFIED = 1480394327502L
