...
printHtmlPart(14)
for( _it1427089775 in (keywordsIn) ) {
changeItVariable(_it1427089775)
printHtmlPart(15)
...
printHtmlPart(14)
for( _it1411865437 in (contacts) ) {
changeItVariable(_it1411865437)
printHtmlPart(66)
...
invokeTag('link','g',431,['action':("dashboard"),'params':([offset: offset, up: 'false', searchQueryHidden: searchQueryHidden]),'type':("button"),'class':("btn btn-default")],3)
printHtmlPart(90)
}
else {
printHtmlPart(91)
...
invokeTag('link','g',437,['action':("dashboard"),'params':([offset: offset, up: 'true', searchQueryHidden: searchQueryHidden]),'type':("button"),'class':("btn btn-default")],3)
printHtmlPart(90)
}
else {
printHtmlPart(93)
...
invokeTag('link','g',484,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("sendTxt"),'params':([contactID: it.contactID]),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(102)
...
invokeTag('link','g',487,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("details"),'params':([contactID: it.contactID, conType: 'Contact']),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(99)
createClosureForHtmlPart(105, 4)
invokeTag('link','g',488,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("groups"),'params':([contactID: it.contactID, addToGroup: 'True']),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(106)
}
printHtmlPart(1)
}
...
printHtmlPart(108)
invokeTag('javascript','g',505,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(109)
invokeTag('javascript','g',507,['src':("dashboard/app.min.js")],-1)
printHtmlPart(110)
})
...
public static final long LAST_MODIFIED = 1480914051354L
