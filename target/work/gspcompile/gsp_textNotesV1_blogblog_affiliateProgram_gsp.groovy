...
class gsp_textNotesV1_blogblog_affiliateProgram_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/blog/blog_affiliateProgram.gsp" }
public Object run() {
Writer out = getOut()
