...
class gsp_textNotesV1_dashboardkeyword_ConWinners_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/keyword_ConWinners.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
for( _it1826807929 in (keywordsIn) ) {
changeItVariable(_it1826807929)
printHtmlPart(15)
...
printHtmlPart(20)
for( _it1043980539 in (winners) ) {
changeItVariable(_it1043980539)
printHtmlPart(57)
expressionOut.print(it.phoneNumber)
printHtmlPart(58)
...
public static final long LAST_MODIFIED = 1479950305044L
