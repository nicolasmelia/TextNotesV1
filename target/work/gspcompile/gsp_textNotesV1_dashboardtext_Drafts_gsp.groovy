...
class gsp_textNotesV1_dashboardtext_Drafts_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/text_Drafts.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
for( _it624593883 in (keywordsIn) ) {
changeItVariable(_it624593883)
printHtmlPart(15)
...
printHtmlPart(14)
for( _it137646750 in (draftList) ) {
changeItVariable(_it137646750)
printHtmlPart(63)
...
invokeTag('link','g',345,['action':("text_Drafts"),'params':([offset: offset, up: 'false', searchQueryHidden: searchQueryHidden]),'type':("button"),'class':("btn btn-default")],3)
printHtmlPart(77)
}
else {
printHtmlPart(78)
...
invokeTag('link','g',351,['action':("text_Drafts"),'params':([offset: offset, up: 'true', searchQueryHidden: searchQueryHidden]),'type':("button"),'class':("btn btn-default")],3)
printHtmlPart(77)
}
else {
printHtmlPart(80)
...
public static final long LAST_MODIFIED = 1479676719902L
