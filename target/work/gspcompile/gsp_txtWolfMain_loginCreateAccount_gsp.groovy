...
printHtmlPart(26)
invokeTag('actionSubmit','g',135,['class':("special"),'id':("submitBtn"),'onclick':("return validateForm()"),'value':("Create Account"),'action':("createAccount"),'style':("width: 100%")],-1)
printHtmlPart(27)
})
invokeTag('form','g',144,['class':("form-signin"),'controller':("Login"),'action':("createAccount"),'enctype':("multipart/form-data")],2)
printHtmlPart(28)
expressionOut.print(createLink(controller: 'affiliateProgram'))
printHtmlPart(29)
expressionOut.print(createLink(controller: 'blog', params: [blogID: '1']))
...
printHtmlPart(31)
invokeTag('javascript','g',206,['src':("jquery.min.js")],-1)
printHtmlPart(32)
invokeTag('javascript','g',207,['src':("jquery.dropotron.min.js")],-1)
printHtmlPart(33)
invokeTag('javascript','g',208,['src':("jquery.scrollgress.min.js")],-1)
printHtmlPart(32)
invokeTag('javascript','g',209,['src':("skel.min.js")],-1)
printHtmlPart(32)
invokeTag('javascript','g',210,['src':("util.js")],-1)
printHtmlPart(34)
invokeTag('javascript','g',211,['src':("main.js")],-1)
printHtmlPart(34)
invokeTag('javascript','g',212,['src':("jquery.scrolly.min.js")],-1)
printHtmlPart(35)
invokeTag('javascript','g',213,['src':("ie/respond.min.js")],-1)
printHtmlPart(36)
})
...
public static final long LAST_MODIFIED = 1483387903706L
