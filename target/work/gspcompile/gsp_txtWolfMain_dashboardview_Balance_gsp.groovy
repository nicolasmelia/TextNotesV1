...
class gsp_txtWolfMain_dashboardview_Balance_gsp extends GroovyPage {
...
printHtmlPart(14)
for( _it694103323 in (keywordsIn) ) {
changeItVariable(_it694103323)
printHtmlPart(15)
...
expressionOut.print(bal.monthlyBalance)
printHtmlPart(62)
invokeTag('formatDate','g',296,['format':("MM-dd-yyyy"),'date':(bal.monthlyResetDate)],-1)
printHtmlPart(63)
createClosureForHtmlPart(64, 2)
invokeTag('link','g',301,['class':("btn btn-default"),'action':("history"),'params':([]),'type':("button")],2)
printHtmlPart(65)
createClosureForHtmlPart(66, 2)
invokeTag('link','g',302,['class':("btn btn-default"),'action':("dashboard"),'params':([]),'type':("button")],2)
printHtmlPart(67)
createClosureForHtmlPart(68, 2)
invokeTag('link','g',320,['action':("suspendKeyword"),'params':([promotionID:params.promotionID]),'type':("button"),'class':("btn btn-warning pull-left")],2)
printHtmlPart(69)
invokeTag('javascript','g',347,['src':("dashboard/plugins/jQuery/jQuery-2.1.4.min.js")],-1)
printHtmlPart(70)
invokeTag('javascript','g',349,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(71)
invokeTag('javascript','g',351,['src':("dashboard/app.min.js")],-1)
printHtmlPart(72)
})
invokeTag('captureBody','sitemesh',378,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(73)
}
...
public static final long LAST_MODIFIED = 1483923623300L
