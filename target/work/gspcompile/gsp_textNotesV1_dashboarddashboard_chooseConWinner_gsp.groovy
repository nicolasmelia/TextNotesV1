...
invokeTag('form','g',306,['id':("txtForm"),'class':("form-horizontal"),'controller':("Dashboard"),'action':("contestSelect"),'style':("margin: auto;"),'enctype':("multipart/form-data")],2)
printHtmlPart(65)
invokeTag('javascript','g',387,['src':("dashboard/plugins/jQuery/jQuery-2.1.4.min.js")],-1)
printHtmlPart(66)
invokeTag('javascript','g',389,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(67)
invokeTag('javascript','g',391,['src':("dashboard/app.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',392,['src':("dashboard/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',393,['src':("dashboard/plugins/select2/select2.full.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',394,['src':("tagsinput/dist/bootstrap-tagsinput.min.js")],-1)
printHtmlPart(68)
invokeTag('javascript','g',396,['src':("dashboard/plugins/input-mask/jquery.inputmask.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',397,['src':("dashboard/plugins/input-mask/jquery.inputmask.date.extensions.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',398,['src':("dashboard/plugins/input-mask/jquery.inputmask.extensions.js")],-1)
printHtmlPart(69)
invokeTag('javascript','g',401,['src':("dashboard/plugins/daterangepicker/daterangepicker.js")],-1)
printHtmlPart(70)
invokeTag('javascript','g',403,['src':("dashboard/plugins/colorpicker/bootstrap-colorpicker.min.js")],-1)
printHtmlPart(71)
invokeTag('javascript','g',405,['src':("dashboard/plugins/timepicker/bootstrap-timepicker.min.js")],-1)
printHtmlPart(72)
invokeTag('javascript','g',407,['src':("dashboard/plugins/slimScroll/jquery.slimscroll.min.js")],-1)
printHtmlPart(73)
invokeTag('javascript','g',409,['src':("dashboard/plugins/iCheck/icheck.min.js")],-1)
printHtmlPart(74)
invokeTag('javascript','g',411,['src':("dashboard/plugins/fastclick/fastclick.min.js")],-1)
printHtmlPart(75)
})
invokeTag('captureBody','sitemesh',441,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(76)
}
...
public static final long LAST_MODIFIED = 1473111078581L
