...
class gsp_textNotesV1_dashboardview_Confirmation_gsp extends GroovyPage {
...
invokeTag('link','g',287,['class':("btn btn-default"),'action':("details"),'params':([conType: 'Message', messageID: params.messageID]),'type':("button")],3)
printHtmlPart(70)
}
...
invokeTag('link','g',307,['class':("btn btn-default"),'action':("sendTxt"),'params':([contactID: params.contactID]),'type':("button")],3)
printHtmlPart(74)
createClosureForHtmlPart(69, 3)
invokeTag('link','g',308,['class':("btn btn-default"),'action':("details"),'params':([contactID: params.contactID, conType: 'Contact']),'type':("button")],3)
printHtmlPart(75)
}
...
invokeTag('link','g',328,['class':("btn btn-default"),'action':("sendTxt"),'params':([contactID: params.contactID]),'type':("button")],3)
printHtmlPart(74)
createClosureForHtmlPart(69, 3)
invokeTag('link','g',329,['class':("btn btn-default"),'action':("details"),'params':([contactID: params.contactID, conType: 'Contact']),'type':("button")],3)
printHtmlPart(75)
}
...
printHtmlPart(86)
createClosureForHtmlPart(69, 3)
invokeTag('link','g',388,['class':("btn btn-default"),'action':("detailedGroup"),'params':([groupID: params.groupID]),'type':("button")],3)
printHtmlPart(75)
}
...
printHtmlPart(68)
createClosureForHtmlPart(69, 3)
invokeTag('link','g',408,['class':("btn btn-default"),'action':("details"),'params':([groupID: params.groupID]),'type':("button")],3)
printHtmlPart(75)
}
