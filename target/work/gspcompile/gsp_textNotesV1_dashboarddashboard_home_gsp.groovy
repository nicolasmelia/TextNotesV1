...
printHtmlPart(14)
for( _it844008362 in (keywordsIn) ) {
changeItVariable(_it844008362)
printHtmlPart(15)
...
invokeTag('link','g',406,['action':("dashboard"),'params':([offset: offset, up: 'false', searchQueryHidden: searchQueryHidden]),'type':("button"),'class':("btn btn-default")],3)
printHtmlPart(85)
}
else {
printHtmlPart(86)
...
invokeTag('link','g',412,['action':("dashboard"),'params':([offset: offset, up: 'true', searchQueryHidden: searchQueryHidden]),'type':("button"),'class':("btn btn-default")],3)
printHtmlPart(85)
}
else {
printHtmlPart(88)
...
invokeTag('link','g',450,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("sendTxt"),'params':([contactID: it.contactID]),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(96)
createClosureForHtmlPart(97, 4)
invokeTag('link','g',452,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("editContact"),'params':([contactID: it.contactID]),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(98)
createClosureForHtmlPart(99, 4)
invokeTag('link','g',453,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("details"),'params':([contactID: it.contactID, conType: 'Contact']),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(98)
createClosureForHtmlPart(100, 4)
invokeTag('link','g',454,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("groups"),'params':([contactID: it.contactID, addToGroup: 'True']),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(101)
}
printHtmlPart(1)
}
printHtmlPart(102)
invokeTag('javascript','g',469,['src':("dashboard/plugins/jQuery/jQuery-2.1.4.min.js")],-1)
printHtmlPart(103)
invokeTag('javascript','g',471,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(104)
invokeTag('javascript','g',473,['src':("dashboard/app.min.js")],-1)
printHtmlPart(105)
})
invokeTag('captureBody','sitemesh',474,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(106)
}
...
public static final long LAST_MODIFIED = 1473130118413L
