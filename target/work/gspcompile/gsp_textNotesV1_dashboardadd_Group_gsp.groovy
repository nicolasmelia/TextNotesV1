...
class gsp_textNotesV1_dashboardadd_Group_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/add_Group.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
for( _it1171055810 in (keywordsIn) ) {
changeItVariable(_it1171055810)
printHtmlPart(15)
