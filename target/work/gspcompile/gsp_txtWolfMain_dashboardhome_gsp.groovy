...
class gsp_txtWolfMain_dashboardhome_gsp extends GroovyPage {
...
printHtmlPart(14)
for( _it181220448 in (keywordsIn) ) {
changeItVariable(_it181220448)
printHtmlPart(15)
...
printHtmlPart(18)
invokeTag('formatDate','g',80,['format':("MM-dd-yyyy"),'date':(it.date)],-1)
printHtmlPart(19)
}
printHtmlPart(20)
}
...
printHtmlPart(31)
invokeTag('formatDate','g',133,['format':("yyyy"),'date':(session.signUpDate)],-1)
printHtmlPart(32)
...
invokeTag('form','g',174,['controller':("Dashboard"),'action':("contacts"),'enctype':("multipart/form-data"),'class':("sidebar-form")],2)
printHtmlPart(38)
expressionOut.print(createLink(controller: 'Dashboard', action: 'Dashboard'))
printHtmlPart(39)
...
printHtmlPart(14)
for( _it1051304081 in (contacts) ) {
changeItVariable(_it1051304081)
printHtmlPart(66)
...
invokeTag('link','g',441,['action':("dashboard"),'params':([offset: offset, up: 'false', searchQueryHidden: searchQueryHidden]),'type':("button"),'class':("btn btn-default")],3)
printHtmlPart(90)
}
else {
printHtmlPart(91)
...
invokeTag('link','g',447,['action':("dashboard"),'params':([offset: offset, up: 'true', searchQueryHidden: searchQueryHidden]),'type':("button"),'class':("btn btn-default")],3)
printHtmlPart(90)
}
else {
printHtmlPart(93)
...
printHtmlPart(96)
for( _it385131456 in (contacts) ) {
changeItVariable(_it385131456)
printHtmlPart(97)
expressionOut.print(it.contactID)
printHtmlPart(98)
if(true && (it.firstName == 'Unknown')) {
...
invokeTag('link','g',494,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("sendTxt"),'params':([contactID: it.contactID]),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(102)
createClosureForHtmlPart(103, 4)
invokeTag('link','g',496,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("editContact"),'params':([contactID: it.contactID]),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(99)
createClosureForHtmlPart(104, 4)
invokeTag('link','g',497,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("details"),'params':([contactID: it.contactID, conType: 'Contact']),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(99)
createClosureForHtmlPart(105, 4)
invokeTag('link','g',498,['style':("margin-bottom:0px; margin-top: 15px; "),'action':("groups"),'params':([contactID: it.contactID, addToGroup: 'True']),'type':("button"),'class':("btn btn-app")],4)
printHtmlPart(106)
}
printHtmlPart(1)
}
printHtmlPart(107)
invokeTag('javascript','g',513,['src':("dashboard/plugins/jQuery/jQuery-2.1.4.min.js")],-1)
printHtmlPart(108)
invokeTag('javascript','g',515,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(109)
invokeTag('javascript','g',517,['src':("dashboard/app.min.js")],-1)
printHtmlPart(110)
})
...
public static final long LAST_MODIFIED = 1483923625320L
