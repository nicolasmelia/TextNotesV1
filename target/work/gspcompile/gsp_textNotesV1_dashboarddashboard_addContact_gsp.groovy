...
class gsp_textNotesV1_dashboarddashboard_addContact_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/dashboard_addContact.gsp" }
public Object run() {
Writer out = getOut()
...
expressionOut.print(session.lastName)
printHtmlPart(17)
invokeTag('formatDate','g',142,['format':("yyyy"),'date':(session.signUpDate)],-1)
printHtmlPart(18)
...
invokeTag('form','g',352,['id':("txtForm"),'class':("form-horizontal"),'controller':("Dashboard"),'action':("addNewContact"),'enctype':("multipart/form-data")],2)
printHtmlPart(25)
...
public static final long LAST_MODIFIED = 1455383041752L
