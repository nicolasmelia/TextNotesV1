...
invokeTag('form','g',377,['id':("txtForm"),'class':("form-horizontal"),'controller':("Dashboard"),'action':("addNewContact"),'enctype':("multipart/form-data")],2)
printHtmlPart(57)
invokeTag('javascript','g',458,['src':("dashboard/plugins/jQuery/jQuery-2.1.4.min.js")],-1)
printHtmlPart(58)
invokeTag('javascript','g',460,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(59)
invokeTag('javascript','g',462,['src':("dashboard/app.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',463,['src':("dashboard/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',464,['src':("dashboard/plugins/select2/select2.full.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',465,['src':("tagsinput/dist/bootstrap-tagsinput.min.js")],-1)
printHtmlPart(60)
invokeTag('javascript','g',467,['src':("dashboard/plugins/input-mask/jquery.inputmask.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',468,['src':("dashboard/plugins/input-mask/jquery.inputmask.date.extensions.js")],-1)
printHtmlPart(1)
invokeTag('javascript','g',469,['src':("dashboard/plugins/input-mask/jquery.inputmask.extensions.js")],-1)
printHtmlPart(61)
invokeTag('javascript','g',472,['src':("dashboard/plugins/daterangepicker/daterangepicker.js")],-1)
printHtmlPart(62)
invokeTag('javascript','g',474,['src':("dashboard/plugins/colorpicker/bootstrap-colorpicker.min.js")],-1)
printHtmlPart(63)
invokeTag('javascript','g',476,['src':("dashboard/plugins/timepicker/bootstrap-timepicker.min.js")],-1)
printHtmlPart(64)
invokeTag('javascript','g',478,['src':("dashboard/plugins/slimScroll/jquery.slimscroll.min.js")],-1)
printHtmlPart(65)
invokeTag('javascript','g',480,['src':("dashboard/plugins/iCheck/icheck.min.js")],-1)
printHtmlPart(66)
invokeTag('javascript','g',482,['src':("dashboard/plugins/fastclick/fastclick.min.js")],-1)
printHtmlPart(67)
})
invokeTag('captureBody','sitemesh',512,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(68)
}
...
public static final long LAST_MODIFIED = 1473110999084L
