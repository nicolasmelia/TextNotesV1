...
createTagBody(2, {->
printHtmlPart(25)
invokeTag('actionSubmit','g',101,['class':("special"),'id':("submitBtn"),'onclick':("return validateForm()"),'value':("Login"),'action':("attemptLogin"),'style':("width: 100%")],-1)
printHtmlPart(26)
})
invokeTag('form','g',110,['class':("form-signin"),'controller':("Login"),'action':("attemptLogin"),'enctype':("multipart/form-data")],2)
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1483922984174L
