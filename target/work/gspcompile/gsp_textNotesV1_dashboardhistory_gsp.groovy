...
class gsp_textNotesV1_dashboardhistory_gsp extends GroovyPage {
...
printHtmlPart(14)
for( _it1643219351 in (keywordsIn) ) {
changeItVariable(_it1643219351)
printHtmlPart(15)
...
printHtmlPart(14)
for( _it1430554384 in (history) ) {
changeItVariable(_it1430554384)
printHtmlPart(68)
...
if(true && (addToGroup)) {
printHtmlPart(90)
for( _it958663331 in (history) ) {
changeItVariable(_it958663331)
printHtmlPart(91)
...
invokeTag('link','g',462,['action':("addToGroup"),'params':([contactID: contactGroupAdd.contactID, groupID: it.groupID]),'type':("button"),'class':("btn btn-primary pull-left")],4)
printHtmlPart(97)
}
printHtmlPart(1)
}
...
printHtmlPart(99)
invokeTag('javascript','g',477,['src':("dashboard/bootstrap/js/bootstrap.min.js")],-1)
printHtmlPart(100)
invokeTag('javascript','g',479,['src':("dashboard/app.min.js")],-1)
printHtmlPart(101)
})
invokeTag('captureBody','sitemesh',484,['class':("hold-transition skin-purple sidebar-mini")],1)
printHtmlPart(102)
}
...
public static final long LAST_MODIFIED = 1478476080503L
