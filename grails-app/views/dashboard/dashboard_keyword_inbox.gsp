          ...
          <!-- search form (Optional) -->
           <g:form   controller="Dashboard" action="dashboard" enctype="multipart/form-data" class="sidebar-form">           
            <div class="input-group">
              <input type="text" name = "searchQuery"  class="form-control" placeholder="Search messages...">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active">
              ...
              <ul class="treeview-menu">
                <li><a href="${createLink(controller: 'Dashboard', action: 'dashboard')}">View messages</a></li> 
  ...
  <section class="content">
      ...
      <g:if test="${clientCount == 0}">	
         <div class="callout callout-info" style="margin-bottom: 10px!important;">
            ...
            It looks like no one sent in your keywords yet. Get started by adding a keyword below!
        </div>
            ...
            <div class="col-xs-12">       
              <div class="box">
                ...
                <div class="input-group margin" style = "width: 250px; margin: 10px 0px 0px 0px;">
                    ...
                    <input id = "seachQueryInput" name = "searchQuery" placeholder="Phone Number..." type="text" class="form-control">
                    <span class="input-group-btn">
                      <g:actionSubmit  action="keywordInbox" class="btn btn-info btn-flat" type="button" value = "Search"></g:actionSubmit>             
                    </span>   
                ...
                <div class="box-body">
				 	...
				 	<g:if test="${messages != 'NONE'}">						 			
	                    <g:each in="${messages}">
	                      ...
	                      <tr   onclick="document.location = '${createLink(controller: 'Dashboard', action: 'details', params: [conType: 'keyword',  promotionID:it.promotionID])}';" class = "pointer" >
	                        ...
	                        <td><g:formatDate format="MM-dd-yyyy" date="${it.date}"/>
	                        </td>
	                      </tr>
                 ...
                 <g:else>
                  ...
                  <g:if test="${isSearch}" >
                      <tr onclick="document.location = '${createLink(controller: 'Dashboard')}';"  class = "pointer" >
                        <td><a href = "#"><b>No Results, try another search or go home.</b></a></td>
                        <td>-</td>
						<td>-</td>
                        <td>-</td>
                      </tr>
