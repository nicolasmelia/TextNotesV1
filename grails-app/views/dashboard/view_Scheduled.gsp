	...
	<div class="wrapper">
			...
			<section class="sidebar">
              ...
              <button action="contacts" name="search" id="search-btn" class="btn btn-flat" ><i class="fa fa-search"></i></button>
				...
				<ul class="sidebar-menu">
					...
					<li class="active"> <a href="#"><i class="fa fa-comment"></i> <span>Send Text</span> <i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<g:if test="${groupCount == -1}">
					<div class="callout callout-info" style="margin-bottom: 10px!important;">
						<h4><i class="fa fa-paw"></i> Getting started!</h4>
						It looks like you dont have any groups yet. Get started by adding a group below! You can use groups to reach certain employees, particular customers and more people in less time.</div>
				</g:if>
					...
					<div class="col-xs-12">
						<div class="box">
							...
							<div class="box-body">
								...
								<table id="example1" class="table table-bordered table-hover">
									...
									<tbody>
										...
										<g:else>
											<tr onclick="document.location = '${createLink(controller: 'Dashboard', action: 'sendTxt')}';" class="pointer">
												<td><a href="#"><b>Nothing scheduled... Click here to send a text!</b></a>
												</td>
												<td>-</td>
												<td>-</td>
												<td>-</td>
							...
							<div class="btn-group" style="margin: 0px 0px 10px 10px; ">
								<g:if test="${offset > 0}">
									<g:link action="dashboard" action="secheduledTxt" params="[offset: offset, up: 'false', searchQueryHidden: searchQueryHidden]" type="button" class="btn btn-default">Back</g:link>
								</g:if>
								<g:else>
									<button disabled type="button" class="btn btn-default">Back</button>
								</g:else>
								<g:if test="${offset <= groupCount}">
									<g:link action="dashboard" action="secheduledTxt" params="[offset: offset, up: 'true', searchQueryHidden: searchQueryHidden]" type="button" class="btn btn-default">Next</g:link>
								</g:if>
								<g:else>
