				...
				<div class="box box-info" style="max-width: 600px;">
					...
					<g:form id="txtForm" class="form-horizontal" controller="Dashboard" action="addNewContact" enctype="multipart/form-data">
						...
						<div class="box-footer">
							<button onClick="return validateMainForm()" class="btn btn-info pull-right" id="submitBtn" value="Send" action="addNewContact" />Add</button> <a href="${createLink(controller: 'Dashboard', action: 'dashboard')}" type="submit" class="btn btn-default">Cancel</a>
						</div>
						<!-- /.box-footer -->
