          ...
          <ul class="sidebar-menu">
            ...
            <li class="active">
              ...
              <ul class="treeview-menu">
                ...
                <li><a class = "fa fa-plus" href="${createLink(controller: 'Dashboard', action: 'newContact')}"> Edit Contact</a></li>    
              </ul>
            </li>
               ...
               <g:form id = "txtForm" class="form-horizontal" controller="Dashboard" action="editContact" enctype="multipart/form-data" >
				...
				<hr>
                  ...
                  <div class="box-footer">
                   <button  onClick = "return validateMainForm()" class="btn btn-info pull-right" id = "submitBtn" value = "Send"  action = "editContact"/>Save Edit</button>	
