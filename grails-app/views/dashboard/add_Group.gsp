		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="box box-info" style="max-width: 600px;">
					...
					<!-- /.box-header -->
					<!-- form start -->
					<g:form id="txtForm" class="form-horizontal" controller="Dashboard" action="createGroup" enctype="multipart/form-data">
						<div class="box-body">
						...
						<div class="box-footer">
							<button onClick="return validateMainForm()" class="btn btn-info pull-right" id="submitBtn" value="Send" action="createGroup" />Create</button> <a href="${createLink(controller: 'Dashboard', action: 'dashboard')}" type="submit" class="btn btn-default">Cancel</a>
						</div>
						<!-- /.box-footer -->
	  ...
	  function validateMainForm() {		  
		  ...
		  var state = $('#state').val();
			...
			$("#ModalAlertText").html("");  
		  	...
		  	if (name.length < 2) {
				error = true;
				errors.push("Please enter a valid group name.");			
			} 
