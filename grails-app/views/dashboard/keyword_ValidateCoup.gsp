		...
		<div class="content-wrapper">
            ...
            <small>Keyword</small>
				...
				<ol class="breadcrumb">
					...
					<li class="active">Validate Coupon Code</li>
				</ol>
			</section>
			<!-- Main content -->
				...
				<div class="box box-info" style="max-width: 600px;">
					...
					<g:form id="txtForm" class="form-horizontal" controller="Dashboard" action="validateCoup" enctype="multipart/form-data">
						<div class="box-body">
							...
							<hr> <span class="fa fa-check"> </span> Redeeming a valid coupon code will automatily set the recipients code to ineligible, unless the keyword allows for multiple uses.</div>
						<!-- /.box-body -->
						<div class="box-footer">
							<button onClick="return validateMainForm()" class="btn btn-info pull-right" id="submitBtn" value="Send" action="validateCoup">Validate</button> <a href="${createLink(controller: 'Dashboard', action: 'dashboard')}" type="submit" class="btn btn-default">Cancel</a>
						</div>
						<!-- /.box-footer -->
					</g:form>
				</div>
