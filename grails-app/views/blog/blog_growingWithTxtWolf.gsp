						...
						<div class="8u$ 12u$(medium) important(medium)">
							...
							<!-- Content -->
								<section id="content">
									...
									<p>
										Texting has, by far, the best engagement rate of any marketing medium. Emails can sit unread, phone calls can go unanswered and leaflets can be thrown out before given a second glance. Whereas text messages are almost always read, and read quickly. As studies have shown, 95% of your customers who have opted into your text messaging list <b>OPEN</b> and <b>READ</b> your mobile messages within 3 minutes.				
									</p>
								</section>
