...
class DashboardController {
	...
	def affiliateDash() {
		render(view:"affiliate_dashboard", model: [UAI: getUserAccountInfo(), notiCount: getNotificationCount(session["userID"]), keywordsIn: getKeywordInboxList(0, 5, null, true,false)])		
	}
	...
	def accountSettings () {
			render(view:"account_Settings",  model: [accountInfo: getUserAccountInfo(), notiCount: getNotificationCount(session["userID"]), keywordsIn: getKeywordInboxList(0, 5, null, true, false)])		
	}
